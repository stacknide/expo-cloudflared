...
Setup is now a single `@expo/ngrok` alias dependency that works identically on npm, yarn (v1 and Berry), pnpm, and bun — replacing the four per-package-manager recipes.
